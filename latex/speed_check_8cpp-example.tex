...
\DoxyCodeLine{\ \ \ \ std::cerr\ <<\ \textcolor{stringliteral}{"{}Wrong\ command\ line\ arguments."{}}\ <<\ std::endl;}
\DoxyCodeLine{\ \ \ \ std::cerr\ <<\ \textcolor{stringliteral}{"{}Usage:\ "{}}\ <<\ argv[0]\ <<\ \textcolor{stringliteral}{"{}\ <N>"{}}\ <<\ std::endl;}
\DoxyCodeLine{\ \ \ \ exit(1);}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{\ \ \textcolor{keywordtype}{int}\ N\ =\ atoi(argv[1]);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{comment}{\ \ \ *\ sum\ up\ from\ 1\ to\ this\ value,}}
...
\DoxyCodeLine{\textcolor{comment}{\ \ \ *\ compute\ reduce\ on\ this\ sequence.}}
\DoxyCodeLine{\textcolor{comment}{\ \ \ */}}
...
\DoxyCodeLine{\ \ \ \ std::cerr\ <<\ \textcolor{stringliteral}{"{}CPARK\ ("{}}\ <<\ cores\ <<\textcolor{stringliteral}{"{}\ cores)\ uses\ "{}}\ <<\ temp\_time\ <<\ \textcolor{stringliteral}{"{}\ ms\(\backslash\)t"{}};}
\DoxyCodeLine{\ \ \ \ std::cerr\ <<\ std::fixed\ <<\ std::setprecision(4)\ <<\ \textcolor{stringliteral}{"{}["{}}\ <<\ (double)temp\_time\ /\ cpp\_time\ <<\ \textcolor{stringliteral}{"{}x]\(\backslash\)n"{}};}
\DoxyCodeLine{}

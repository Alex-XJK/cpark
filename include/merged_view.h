...
/**
 * A view combined from a sequence of views of the same type.
...
//class MergedDiffView;
//
//template <std::ranges::view FirstView>
//class MergedDiffView<FirstView> : public FirstView {
//public:
//  explicit MergedDiffView(FirstView&& first_view)
//      : FirstView(std::forward<FirstView>(first_view)) {}
//};
//
//template <std::ranges::view FirstView, std::ranges::view... OtherViews>
//requires((std::is_same_v<std::ranges::range_value_t<FirstView>,
//                         std::ranges::range_value_t<
//                             OtherViews>>)&&...)
//class MergedDiffView<FirstView, OtherViews...>: public MergedTwoDiffView<FirstView, MergedDiffView<OtherViews...>> {
//public:
//  explicit MergedDiffView(FirstView&& first_view, OtherViews&&... other_views)
//      : MergedTwoDiffView<FirstView, MergedDiffView<OtherViews...>>{
//            std::forward<FirstView>(first_view),
//            MergedDiffView(std::forward<OtherViews>(other_views)...)} {}
//};
